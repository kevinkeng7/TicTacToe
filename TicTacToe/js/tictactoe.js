...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            //if active player is 'X' chang it to 'O'.
            activePlayer = 'O';
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        x = x1,
        //This variable stores temporary y axie data we update in our animation loop.
        y = y1;
    ...
    function animateLineDrawing() {
        ...
        //This methid clears content from last loop iteration.
